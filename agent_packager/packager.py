...
BASE_MODULES = {
    'plugins_common': 'https://github.com/geokala/cloudify-rest-client/archive/ipv6mods.tar.gz',  # NOQA
    "rest_client": "git+git://github.com/cloudify-cosmo/cloudify-rest-client.git@3.2m8",  # NOQA
    'script_plugin': 'https://github.com/cloudify-cosmo/cloudify-script-plugin/archive/master.tar.gz',  # NOQA
    "script_plugin": "git+git://github.com/cloudify-cosmo/cloudify-script-plugin.git@1.2m8",  # NOQA
...
def create(config=None, config_file=None, force=False, verbose=True):
    ...
    version = config.get('management_modules_version', 'ipv6mods')
